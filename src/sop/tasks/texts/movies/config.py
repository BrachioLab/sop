...
class MoviesConfig(BaseConfig):
    def __init__(self, **kwargs):
        super().__init__()
        self._config = {
            'dataset': {
                'name': 'movies',
                'root': '/shared_data0/weiqiuy/sop/data/movies/movies',
            },
            'training': {
                'batch_size': 16,
                'num_epochs': 20,
            ...
            'model': {
                'type': 'bert',
                'base': '/shared_data0/weiqiuy/sop/pt_models/movies_vanilla_lr000001_ep100/best',
                'base_processor': 'bert-base-uncased',
                'sop': '/shared_data0/weiqiuy/sop/notebooks/exps/movies_lr5e-06_tgtnnz0.2_gg16.0000_gs2.0000_fz_attnmasked_topk_by_row_aug_blur15/best',
                'num_classes': 2,
                'base_exp': '/shared_data0/weiqiuy/sop/exps/movies_bert'
            }
        }
